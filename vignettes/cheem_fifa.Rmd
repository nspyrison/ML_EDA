...
Why are we only looking at discrete orthogonal pairs though. Instead of having a 6D cube and only looking at squarely at the sides, lets have a continuus view of the intermediate frames as well; tours.
...
head(maha_dist, n = 6L)
## Mute nise output, keep plot
head(psych::outlier(sub), n = 0) 
